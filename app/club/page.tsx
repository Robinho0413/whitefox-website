    ...
    <div className="relative flex flex-col justify-center items-center w-full overflow-hidden mt-10 px-4 py-12 md:p-16 md:px-36 space-y-10">
      ...
      <div>
        ...
        <div className="flex flex-col justify-center items-center">
          ...
          <p className="text-center text-muted-foreground max-w-3xl mb-4">
            Rejoins-nous pour vivre une aventure humaine et sportive pleine d&apos;énergie, de sourires et de passion.
          </p>
